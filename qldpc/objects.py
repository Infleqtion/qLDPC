    ...
    def __init__(
        ...
        *,
        ...
        if not nx.is_connected(self.graph):
            # take subgraph connected to the identity
            identity_connected_nodes = nx.node_connected_component(self.graph, group.identity)
            self.graph = self.graph.subgraph(identity_connected_nodes)
