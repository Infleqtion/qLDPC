...
class CayleyComplex:
    ...
    - vertices are members of G, which is defined as the group generated by elements of A and B,
    ...
    In fact, condition [2] can be enforced at no added cost by taking the cover of G and modifying
    members of A and B as:
    - G --> G ⊗ {0,1},
    - a --> (a,1), and
    - b --> (b,1),
    where (a,1) acts on (g,i) as (a,1) * (g,i) = (ag,i+1), and similarly (b,1) * (g,i) = (gb,i+1).
    The complex generated by A and B after this modification is the "bipartite" Cayley complex
    constructed in https://arxiv.org/abs/2202.13641.
    ...
    This is the "quadripartite" Cayley complex constructed in in https://arxiv.org/abs/2202.13641.
    ...
    def __init__(
        ...
        *,
        ...
        # symmetrize subsets
        subset_a = subset_a | {~member for member in subset_a}
        subset_b = subset_b | {~member for member in subset_b}
