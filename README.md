...
- `decoders.py`: module for decoding errors with various decoders, including [`pymatching`](https://github.com/oscarhiggott/PyMatching), [BP-OSD](https://github.com/quantumgizmos/ldpc), and others.  Includes an interface for using custom decoders. 
